...
$options = array(
    'header_text' => array(
        'type'  => 'text',
        'value' => 'По умолчанию',
        'label' => __('Header label', MY_THEME_TEXTDOMAIN),
  ...
  /*  ),*/
   ...
   /* 'option_switch' => array(
    ...
    'option_color_picker' => array(
        ...
        'attr'  => array( 'class' => 'custom-class', 'data-foo' => 'bar' ),
        // Палитра цветов
        'palettes' => array( '#2c3e4b', '#757b87', '#757b87' ),
        'label' => __('Label', '{domain}'),
        'desc'  => __('Description', '{domain}'),
        'help'  => __('Help tip', '{domain}'),
    ),
    ...
    /*'option_background_image' => array(
        ...
        'value' => 'bg-1',
        'attr'  => array( 'class' => 'background_image1', 'data-foo' => 'bar' ),
        'label' => __('Background image', MY_THEME_TEXTDOMAIN),
        'desc'  => __('Description', MY_THEME_TEXTDOMAIN),
        'help'  => __('Выбери цвет фона', MY_THEME_TEXTDOMAIN),
        'choices' => array(
            'none' => array(
                'icon' => get_template_directory_uri() . '/images/bg/bg-3.jpg',
                'css'  => array(
   ...
   /* 'option_icon-v2' => array(
    ...
    'option_upload' => array(
        ...
        'value' => array(
            ...
            'url' => 'get_template_directory_uri() . \'/images/bg/bg-1.jpg\''
